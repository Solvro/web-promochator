    ...
    <>
      <div className="w-full flex flex-row justify-between items-center gap-12">
        <div className="flex flex-row gap-2 items-center mr-auto">
          ...
          <p className="text-lg font-semibold">Promo<span className="text-[#5f7ecd]">CHAT</span>or</p>
        </div>
        ...
        <Image src={SolvroLogo} alt="Solvro Logo" className="hidden lg:flex w-40 ml-auto"/>
        {/* Mobile icon */}
        <button title="Otwórz menu" onClick={() => setShowSidebar(true)}
      ...
      {showSidebar && (
        <div
          className="absolute flex lg:hidden bg-[#040314E5] p-6 top-0 right-0 max-w-sm flex flex-col gap-12 items-right justify-start w-full h-full">
