        ...
        <>
            <div className="relative flex flex-col items-center justify-center w-screen lg:h-screen py-24 px-8 z-10">
                <div className="flex flex-col max-w-screen-lg text-center gap-8 lg:gap-12  lg:mt-8" >
                    <div>
                        <h1 className="text-[clamp(2.7rem,5cqw,5rem)] font-bold leading-tight" > Znajdź swojego{" "} <span className="text-colorPrimary">promotora!</span></h1>
                    ...
                    <div className="flex flex-col md:flex-row justify-center gap-4 text-[1.125rem]">
                        <Button asChild variant={"secondary"} className="text-[1.125rem] px-6 py-[1.84rem] rounded-xl">
                            <Link className="flex justify-center items-center gap-2" href="">Wypróbuj <ArrowUpRight size={32} /></Link>
                        </Button>
                        <Button asChild variant={"outline"} className="text-[1.125rem] px-5 py-6 md:px-6 md:py-7 rounded-xl bg-transparent">
                        ...
                        <div className="flex lg:flex-row lg:items-start items-center flex-col-reverse justify-center">
                            <div className="relative lg:mt-6 " >
                                <div className="relative container bg-backgroundChatBot max-w-xs h-auto rounded-3xl  px-5 py-4 mt-4">
                                    ...
                                    <p>Oto{" "} <span className="text-colorPrimary font-semibold"> promotorzy  </span>, którzy mogą Ci pomóc w realizacji tego tematu:</p>
