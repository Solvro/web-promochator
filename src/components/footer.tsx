...
export function Footer() {
  return (
    <div className="mt-8 w-full bg-black p-8 pb-2">
      <div className="mx-auto flex max-w-screen-xl flex-col gap-6">
        <h3 className="pb-3 pt-4 text-4xl font-bold">Najlepszy wybór!</h3>
        <div className="flex flex-col gap-12 md:w-1/2 md:flex-row">
          <div className="mt-2 md:w-2/3">
            <p>
              Promochator jest stroną, która pomoże ci w znalezieniu idealnego
              promotora dopasowanego do twoich potrzeb!
            </p>
          </div>
          <div className="w-1/3">
